...
// updated links for mail
Route::get('/zoop/borrower/esign/{id}', [ZoopController::class, 'borrowerSign'])->name('zoop.borrower.mail.click');
Route::get('/zoop/co-borrower1/esign/{id}', [ZoopController::class, 'coBorrowerSign'])->name('zoop.coborrower1.mail.click');
Route::get('/zoop/co-borrower2/esign/{id}', [ZoopController::class, 'coBorrowerSign2'])->name('zoop.coborrower2.mail.click');
Route::get('/zoop/executant/esign/{id}', [ZoopController::class, 'executantSign'])->name('zoop.executant.mail.click');
Route::get('/zoop/authorised-signatory/esign/{id}', [ZoopController::class, 'authorisedSignatorySign'])->name('zoop.authorised.signatory.mail.click');

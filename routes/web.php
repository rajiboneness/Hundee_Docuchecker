...
Route::get('/esigning-list', [HomeController::class, 'EsigningList'])->name('esigning-list');
...
Route::group(['prefix' => 'user', 'middleware' => ['auth', 'permission']], function () {
    ...
    Route::group(['prefix' => 'employee'], function () {
        Route::get('/', [EmployeeController::class, 'index'])->name('user.emp.list');
        Route::get('/create', [EmployeeController::class, 'create'])->name('user.emp.create');
        Route::post('/store', [EmployeeController::class, 'store'])->name('user.emp.store');
        Route::post('/show', [EmployeeController::class, 'show'])->name('user.emp.show');
        Route::get('/{id}/edit', [EmployeeController::class, 'edit'])->name('user.emp.edit');
        Route::post('/{id}/update', [EmployeeController::class, 'update'])->name('user.emp.update');
        Route::post('/destroy', [EmployeeController::class, 'destroy'])->name('user.emp.destroy');
        Route::post('/block', [EmployeeController::class, 'block'])->name('user.emp.block');
    });
   ...
   // borrower
    ...
    Route::group(['prefix' => 'agreement'], function () {
        ...
        Route::post('/documents/parent-wise-document', [AgreementController::class, 'ParentWiseDocument'])->name('user.agreement.parent-wise-document');
        // New Document 
    ...
    Route::group(['prefix' => 'document'], function(){
        ...
        Route::get('/rejectionreason-list', [DocumentController::class, 'RejectionReasonList'])->name('user.document.rejectionreason-list');
        Route::post('/rejectionreason-create', [DocumentController::class, 'RejectionReasonCreate'])->name('user.document.rejectionreason-create');
        Route::post('/rejectionreason-edit', [DocumentController::class, 'RejectionReasonEdit'])->name('user.document.rejectionreason-edit');
        Route::post('/rejectionreason-delete', [DocumentController::class, 'RejectionReasonDelete'])->name('user.document.rejectionreason-delete');
        ...
        Route::post('/default-loan-number', [DocumentController::class, 'DefailtLoanNumberSet'])->name('user.document.default-loan-number');
    });
    Route::group(['prefix' => 'docu-checker'], function(){
        ...
        Route::get('/details-check/{id}', [DocumentController::class, 'CustomerDucuchecker'])->name('user.docu-checker.details');
        Route::post('/docuchecker-status', [DocumentController::class,'DocucheckerStatus'])->name('user.borrower.docuchecker-status');
        Route::post('/rejection-reason-list', [DocumentController::class,'DocucheckerReasonList'])->name('user.borrower.rejection-reason-list');
        Route::post('/additional-reason-list', [DocumentController::class,'AddtionalReasonList'])->name('user.borrower.additional-reason-list');
        Route::post('/documentexpirydate', [DocumentController::class,'DocucheckerExpiryDate'])->name('user.borrower.docucheckerexpirydate');
        Route::post('/create-enquiry', [DocumentController::class,'DocucheckerNewEnquiry'])->name('user.borrower.createnewenquiry');
        Route::post('/update-enquiry', [DocumentController::class,'DocucheckerUpdateEnquiry'])->name('user.borrower.update-enquiry');
        Route::get('/enquiry-list', [DocumentController::class,'EnquiryList'])->name('user.customer.enquiry-list');
        Route::get('/maildetails', [DocumentController::class,'RmMailDetails'])->name('user.docu-checker.maildetails');
        Route::get('/additional-list', [DocumentController::class, 'AdditionalList'])->name('user.customer.additional-list');
        Route::post('/additional-store', [DocumentController::class, 'AdditionalStore'])->name('user.customer.additional-store');
        Route::post('/additional-update', [DocumentController::class, 'AdditionalUpdate'])->name('user.document.additional-update');
        Route::post('/additional-delete', [DocumentController::class, 'AdditionalDelete'])->name('user.document.additional-delete');
        Route::post('/notify-mail', [DocumentController::class, 'NotifyMail'])->name('user.docuchecker.notify-mail');
        Route::get('/enquiry/export', [DocumentController::class, 'EnquiryExport'])->name('user.docuchecker.enquiry.export');
        Route::post('/additional-document/store', [DocumentController::class, 'AdditionalReasonStore'])->name('user.docucheccker.additional-document.store');
        Route::post('/additional-status', [DocumentController::class, 'AdditionalStatus'])->name('user.docucheccker.additional-status');
    });

...
{
    $cbg_det = [];
    $cbg_det['prefix_cb1'] = AgreementData::where('rfq_id',$id)->where('field_name','prefixofthecoborrower')->get('field_value')[0]->field_value;
    $cbg_det['name_cb1'] = AgreementData::where('rfq_id',$id)->where('field_name','nameofthecoborrower')->get('field_value')[0]->field_value;
    $cbg_det['mobile_cb1'] = AgreementData::where('rfq_id',$id)->where('field_name','mobilenumberofthecoborrower')->get('field_value')[0]->field_value;
    $cbg_det['email_cb1'] = AgreementData::where('rfq_id',$id)->where('field_name','emailidofthecoborrower')->get('field_value')[0]->field_value;

    $cbg_det['prefix_cb2'] = AgreementData::where('rfq_id',$id)->where('field_name','prefixofthecoborrower2')->get('field_value')[0]->field_value;
    $cbg_det['name_cb2'] = AgreementData::where('rfq_id',$id)->where('field_name','nameofthecoborrower2')->get('field_value')[0]->field_value;
    $cbg_det['mobile_cb2'] = AgreementData::where('rfq_id',$id)->where('field_name','mobilenumberofthecoborrower2')->get('field_value')[0]->field_value;
    $cbg_det['email_cb2'] = AgreementData::where('rfq_id',$id)->where('field_name','emailidofthecoborrower2')->get('field_value')[0]->field_value;

    $cbg_det['prefix_gur'] = AgreementData::where('rfq_id',$id)->where('field_name','prefixoftheguarantor')->get('field_value')[0]->field_value;
    $cbg_det['name_gur'] = AgreementData::where('rfq_id',$id)->where('field_name','nameoftheguarantor')->get('field_value')[0]->field_value;
    $cbg_det['mobile_gur'] = AgreementData::where('rfq_id',$id)->where('field_name','mobilenumberoftheguarantor')->get('field_value')[0]->field_value;
    $cbg_det['email_gur'] = AgreementData::where('rfq_id',$id)->where('field_name','emailidoftheguarantor')->get('field_value')[0]->field_value;

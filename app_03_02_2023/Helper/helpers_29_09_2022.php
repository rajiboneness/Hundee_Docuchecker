    ...
    switch ($type) {
        ...
        case 'select':
            ...
            if ($key_name == "highesteducationoftheborrower") {
                $option = '<option value="" selected hidden>Select Highest qualification of the Borrower</option>';
                ...
                $option = '<option value="" selected hidden>Select Highest qualification of the Co-borrower</option>';
                foreach ($highestQualifications as $index => $val) {
                    $selected = '';
                    // if (strtolower($respValue) == strtolower($val)) $selected = 'selected';
                ...
                $option = '<option value="" selected hidden>Select Highest qualification of the Co-borrower 2</option>';
                foreach ($highestQualifications as $index => $val) {
                    $selected = '';
                    // if (strtolower($respValue) == strtolower($val)) $selected = 'selected';
                ...
                $option = '<option value="" selected hidden>Select Highest qualification of the Guarantor</option>';
                foreach ($highestQualifications as $index => $val) {
                    $selected = '';
                    // if (strtolower($respValue) == strtolower($val)) $selected = 'selected';
        ...
        case 'radio':
            ...
            foreach ($expValue as $index => $val) {
                ...
                $option .= '<input class="form-check-input" type="radio" name="field_name[' . $key_name . ']" id="' . $key_name . '-' . $index . '" value="' . $val . '" ' . $required . ' ' . $checked . ' '.$disabledField.'> <label style="white-space: break-spaces;" for="' . $key_name . '-' . $index . '" class="form-check-label mr-1">' . $val . '</label><input type="hidden" value="' . $field_id . '" name="field_id[' . $field_id . ']"> <div></div>  ';
            }
            $response = '<div class="w-100"><div class="form-check nowrap">' . $option . '</div>'.$optionalFieldsData.'</div>';
            break;
        case 'textarea':

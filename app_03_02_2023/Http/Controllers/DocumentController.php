...
class DocumentController extends Controller
{
    ...
    public function CustomerList(Request $request){
        ...
        $borrowers = $query->where('block', 0)->orderBy('full_name', 'asc')->get();

        // $borrowers = Borrower::orderby('full_name', 'asc')->where('block', 0)->get();
        $officeData = Office::orderby('name', 'asc')->get();
        $Agreement = Agreement::latest()->get();
        return view('admin.document.customer', compact('borrowers', 'officeData', 'Agreement'));
    }

        ...
        <div id="DivIdToPrint">
                    ...
                    <tr style="border: 0">
                        ...
                        <td>
                            ...
                            <ol style="max-width: 60%; margin: 0 auto; text-align: left;">
                                <li>{{$data->nameofthecoborrower}} Lorem </li>
                                <li>{{$data->nameofthecoborrower}} Lorem </li>
                            </ol>
                            <div class="sign-line"></div>
                            <b>Co-Borrower</b>
                ...
                <table class="table_23 border0" style="width:100%; margin:0 auto;">
                    <tr>
                        <td style="text-align:right;" class="border0" colspan="2">
                            ...
                            <p class="ft131">Rs. <span style="border-bottom: 1px solid #000;">{{$data->demandpromissorynoteforborroweramount}}/-</span></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border0" colspan="2">
                            <p class="ft131">
                                ...
                                <span style="border-bottom: 1px solid #000;">(Rupees {{$data->loanamountindigitsinwords}})</span>
            ...
            <div class="page" id="page_35">
                <div style="text-align:center;">
                    ...
                    <br><br><br>
                    <img src="{{asset($data->annexurefiveimagepageone)}}" class="p-3" style="width: 100%; height: 60%;">
                </div>
            ...
            <div class="page" id="page_36">
                <div style="text-align:center;">
                    ...
                    <br><br><br>
                    <img src="{{asset($data->annexurefiveimagepagetwo)}}" class="p-3" style="width: 100%; height: 60%;">
                </div>

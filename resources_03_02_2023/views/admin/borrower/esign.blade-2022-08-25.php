                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        @php
                                            $all_auth_sig = App\Models\User::where('user_type',1)->get();
                                        @endphp
                                        <select name="authorised_signatory_name" onchange="setValue(this)" id="authorised_signatory_name" class="form-control">
                                            @foreach ($all_auth_sig as $item)
                                                <option value="{{$item->id}}" data-email="{{$item->email}}" data-city="{{$item->city}}">{{$item->name}}</option>      
                                            @endforeach
                                        </select>
...
@section('script')
    <script>
        function setValue(x){
            const email = event.target.selectedOptions[0].getAttribute('data-email');
            const city = event.target.selectedOptions[0].getAttribute('data-city');

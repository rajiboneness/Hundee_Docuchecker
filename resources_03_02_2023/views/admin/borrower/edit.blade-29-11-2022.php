                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select type="text"
                                            ...
                                            id="KYC_POST_OFFICE" name="KYC_POST_OFFICE"
            ...
            $.ajax({
                ...
                success: function(result){
                    result[0].PostOffice.forEach(element => {
                        if (element.Name == "{{$data->user->KYC_District}}") {
                            $('#KYC_POST_OFFICE').append('<option value="'+element.Name+'" selected>'+element.Name+'</option>')
                        }else{
                            $('#KYC_POST_OFFICE').append('<option value="'+element.Name+'">'+element.Name+'</option>')
                        }
                    });

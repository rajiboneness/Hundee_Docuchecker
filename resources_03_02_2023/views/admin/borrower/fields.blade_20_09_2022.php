                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    @if ($data->agreementRfq > 0)
                                        <div class="mb-2">
                                            <a href="{{route('user.borrower.setAnnexure5doc',[$id])}}" class="btn btn-sm btn-{{ ($data->annX5dataCount == 0) ? 'danger' : 'success' }}">
                                                {!! ($data->annX5dataCount == 0) ? '<i class="fas fa-info-circle mr-2"></i>' : '<i class="fas fa-check-circle mr-2"></i>' !!}
                                                ANEXTURE-V Content
                                            </a>
                                            ...
                                            {{-- @if (
                                            $data->stampPaper1->front_file_path != "" || $data->stampPaper2->front_file_path != "" ||
                                            $data->stampPaper3->front_file_path != "" || $data->stampPaper4->front_file_path != ""
                                            ) --}}
                                                <a href="#viewPdfModal" data-toggle="modal" class="btn btn-sm btn-success">
                                                    <i class="fas fa-check-circle mr-2"></i> Stamp Paper
                                                </a>
                                            @else
                                                <a href="#viewPdfModal" data-toggle="modal" class="btn btn-sm btn-danger">
                                                    <i class="fas fa-info-circle mr-2"></i> Stamp Paper
                                                </a>
                                            @endif

                                            @if( ($data->annX5dataCount > 0) && ($data->annX5dataCount > 0) )
                                                <a href="javascript:void(0)" onclick="return annexureVdata(`{{ route('user.esign.borrower.detail', [$data->borrower_id, $id, $data->rfqDetails->id]) }}`)" id="eSignatureSendBtn" class="btn btn-sm btn-secondary">
                                        ...
                                        @if( ($data->annX5dataCount > 0) && ($data->annX5dataCount > 0) )
                                            <div>
                                                <a href="{{ route('user.borrower.agreement.pdf.view.web', [$data->borrower_id, $data->agreement_id, $id]) }}" class="btn btn-sm btn-primary" target="_blank">
                                                    <i class="fas fa-file-pdf"></i> View PDF
                                                </a>

                                                <a href="{{ route('user.borrower.agreement.pdf.view.web', [$data->borrower_id, $data->agreement_id, $id, 'status' => 'download']) }}" class="btn btn-sm btn-primary" target="_blank">
                                    ...
                                    <div id="100rs_stamp_image">
                                        @if($data->stampPaper1)
                                            <div class="w-100">
                                                ...
                                                <img src="{{ asset($data->stampPaper1->front_file_path) }}" alt="" style="height: 100px">
                                            </div>
                                            <hr>
                                        @endif
                                    </div>

                                    <div class="card-title font-weight-bold mb-3 text-muted">Available 100Rs Estamps - <span class="text-dark" id="100rs_available_stamp">{{ availableStampNew(100)->count() }}</span> </div>
                                ...
                                <div class="card-body p-1 py-3">
                                    <div id="10rs_stamp_image_page_1">
                                        @if($data->stampPaper2)
                                            <div class="w-100">
                                                <p class="small text-muted mb-2">Used Stamp</p>
                                                <img src="{{ asset($data->stampPaper2->front_file_path) }}" alt="" style="height: 100px">
                                            </div>
                                            <hr>
                                        @endif
                                    </div>
                                    <div class="card-title font-weight-bold mb-3 text-muted">Available 10Rs Estamps - <span class="text-dark available_10rs_stamp">{{ availableStampNew(10)->count() }}</span> </div>
                                ...
                                <div class="card-body p-1 py-3">
                                    ...
                                    <div id="50rs_stamp_image">
                                        @if($data->stampPaper3)
                                            <div class="w-100">
                                                <p class="small text-muted mb-2">Used Stamp</p>
                                                <img src="{{ asset($data->stampPaper3->front_file_path) }}" alt="" style="height: 100px">
                                            </div>
                                            <hr>
                                        @endif
                                    </div>

                                    <div class="card-title font-weight-bold mb-3 text-muted">Available 50Rs Estamps - <span class="text-dark available_50rs_stamps">{{ availableStampNew(50)->count() }}</span> </div>
                                ...
                                <div class="card-body p-1 py-3">
                                    ...
                                    <div id="100rs_stamp_image_page2">
                                        @if($data->stampPaper4)
                                            <div class="w-100">
                                                <p class="small text-muted mb-2">Used Stamp</p>
                                                <img src="{{ asset($data->stampPaper4->front_file_path) }}" alt="" style="height: 100px">
                                            </div>
                                            <hr>
                                        @endif
                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(res){
                        if (res != "No-data") {
                            ...
                            // console.log(details);
                            $('select[name="field_name[prefixofthecoborrower]"]').val(details.prefix).change();
                            ...
                            for(i=0; i<$cb_vd_len; i++){
                                if($('input[name="field_name[officiallyvaliddocumentsofthecoborrower]"]').eq(i).val() == details.validdoc){
                                    $('input[name="field_name[officiallyvaliddocumentsofthecoborrower]"]').eq(i).attr('checked',true);
                                }
                            }
                            
                            $cb_rs_len = $('input[name="field_name[residentstatusofthecoborrower]"]').length
                            for(i=0; i<$cb_rs_len; i++){
                                if($('input[name="field_name[residentstatusofthecoborrower]"]').eq(i).val() == details.resident_status){
                                    $('input[name="field_name[residentstatusofthecoborrower]"]').eq(i).attr('checked',true);
                                }
                            }
                            
                            $('input[name="field_name[streetaddressofthecoborrower]"]').val(details.streetadress);
                            ...
                            $('input[name="field_name[occupationofthecoborrower]"]').val(details.occupation);
                            $('select[name="field_name[maritalstatusofthecoborrower]"]').val(details.material_status).change();
                            $('select[name="field_name[highesteducationofthecoborrower]"]').val(details.highest_ed).change();
                            $('input[name="field_name[mobilenumberofthecoborrower]"]').val(details.mobile);
                            ...
                            $cb_vd_len = $('input[name="field_name[officiallyvaliddocumentsofthecoborrower]"]').length
                            for(i=0; i<$cb_vd_len; i++){
                                $('input[name="field_name[officiallyvaliddocumentsofthecoborrower]"]').eq(i).attr('checked',false);
                            }
                ...
                $.ajax({
                    ...
                    success: function(res){
                        if (res != "No-data") {
                            const details = JSON.parse(res);
                            // console.log(details);
                            $('select[name="field_name[prefixofthecoborrower2]"]').val(details.prefix).change();
                            ...
                            for(i=0; i<$cb_vd_len; i++){
                                if($('input[name="field_name[officiallyvaliddocumentsofthecoborrower2]"]').eq(i).val() == details.validdoc){
                                    $('input[name="field_name[officiallyvaliddocumentsofthecoborrower2]"]').eq(i).attr('checked',true);
                                }
                            }
                            
                            $cb_rs_len = $('input[name="field_name[residentstatusofthecoborrower2]"]').length
                            for(i=0; i<$cb_rs_len; i++){
                                if($('input[name="field_name[residentstatusofthecoborrower2]"]').eq(i).val() == details.resident_status){
                                    $('input[name="field_name[residentstatusofthecoborrower2]"]').eq(i).attr('checked',true);
                                }
                            }
                            
                            $('input[name="field_name[streetaddressofthecoborrower2]"]').val(details.streetadress);
                            ...
                            $('input[name="field_name[occupationofthecoborrower2]"]').val(details.occupation);
                            $('select[name="field_name[maritalstatusofthecoborrower2]"]').val(details.material_status).change();
                            $('select[name="field_name[highesteducationofthecoborrower2]"]').val(details.highest_ed).change();
                            $('input[name="field_name[mobilenumberofthecoborrower2]"]').val(details.mobile);
                            ...
                            $cb_vd_len = $('input[name="field_name[officiallyvaliddocumentsofthecoborrower2]"]').length
                            for(i=0; i<$cb_vd_len; i++){
                                $('input[name="field_name[officiallyvaliddocumentsofthecoborrower2]"]').eq(i).attr('checked',false);
                            }
                ...
                $.ajax({
                    ...
                    success: function(res){
                        if (res != "No-data") {
                            const details = JSON.parse(res);
                            // console.log(details);
                            $('select[name="field_name[prefixoftheguarantor]"]').val(details.prefix).change();
                            ...
                            for(i=0; i<$cb_vd_len; i++){
                                if($('input[name="field_name[officiallyvaliddocumentsoftheguarantor]"]').eq(i).val() == details.validdoc){
                                    $('input[name="field_name[officiallyvaliddocumentsoftheguarantor]"]').eq(i).attr('checked',true);
                                }
                            }
                            
                            $cb_rs_len = $('input[name="field_name[residentstatusoftheguarantor]"]').length
                            for(i=0; i<$cb_rs_len; i++){
                                if($('input[name="field_name[residentstatusoftheguarantor]"]').eq(i).val() == details.resident_status){
                                    $('input[name="field_name[residentstatusoftheguarantor]"]').eq(i).attr('checked',true);
                                }
                            }
                            
                            $('input[name="field_name[streetaddressoftheguarantor]"]').val(details.streetadress);
                            ...
                            $('input[name="field_name[occupationoftheguarantor]"]').val(details.occupation);
                            $('select[name="field_name[maritalstatusoftheguarantor]"]').val(details.material_status).change();
                            $('select[name="field_name[highesteducationoftheguarantor]"]').val(details.highest_ed).change();
                            $('input[name="field_name[mobilenumberoftheguarantor]"]').val(details.mobile);
                            ...
                            $cb_vd_len = $('input[name="field_name[officiallyvaliddocumentsoftheguarantor]"]').length
                            for(i=0; i<$cb_vd_len; i++){
                                $('input[name="field_name[officiallyvaliddocumentsoftheguarantor]"]').eq(i).attr('checked',false);
                            }
                                ...
                                if (result.tile == 'success') {
                                    ...
                                    if (page_no == 3) {
                                        ...
                                        $('#100rs_stamp_image').html('<div class="w-100">'+
                                                    '<p class="small text-muted mb-2">Used Stamp</p>'+
                                                    '<img src="' + window.location.origin + '/' + result.usedStampImage + '" alt="" style="height: 100px"></div><hr>');

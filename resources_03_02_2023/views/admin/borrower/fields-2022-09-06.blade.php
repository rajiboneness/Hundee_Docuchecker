                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 text-right">
                                    @if ($data->agreementRfq > 0)
                                        ...
                                        <a href="{{route('user.borrower.setAnnexure5doc',[$id])}}" class="btn btn-sm btn-secondary">ANEXTURE-V Content</a>

                                        <a href="javascript:void(0)" onclick="return annexureVdata(`{{ route('user.esign.borrower.detail', [$data->borrower_id, $id, $data->rfqDetails->id]) }}`)" id="eSignatureSendBtn"
                                            class="btn btn-sm btn-secondary" data-disable = "{{count($annexurevdata) > 0 ? '' : 'disable'}}"><i

    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    <a href="{{route('user.borrower.list',['show'=>'borrowers'])}}" class="d-flex"><span class="info-box-icon text-info elevation-1"><i class="fas fa-users-cog"></i></span></a>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    <a href="{{ route('user.borrower.list',['show'=>'borrower & agreement'])  }}" class="d-flex"><span class="info-box-icon text-info elevation-1"><i class="fas fa-users-cog"></i></span></a>
                    <div class="info-box-content">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    <a href="{{route('user.agreement.list')}}" class="d-flex"><span class="info-box-icon text-success elevation-1"><i class="fas fa-edit"></i></span></a>
                    <div class="info-box-content">
                        <span class="info-box-text">Complete agreements</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Pending agreements</span>
                        <span class="info-box-number">1</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    <a href="{{route('user.borrower.list',['show'=>'borrowers'])}}" class="d-flex"><span class="info-box-icon text-info elevation-1"><i class="fas fa-users-cog"></i></span></a>
                    <div class="info-box-content">
                        <span class="info-box-text">Customers listed today</span>
                        <span class="info-box-number">
                            {{$data->borrower_today}}
                            {{-- <small>%</small> --}}
                        </span>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-footer clearfix">
                        ...
                        <a href="{{route('user.borrower.list',['show'=>'borrowers'])}}" class="btn btn-sm btn-secondary float-right">View customer's list</a>
                    </div>
                </div>
            </div>

                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active pt-3" id="rs10" role="tabpanel" aria-labelledby="rs10-tab">
                                ...
                                <form action="{{ route('user.estamp.store') }}" method="POST" enctype="multipart/form-data" id="ten_rs_stamp_form">
                                    ...
                                    <input type="hidden" name="image" class="front_image_cropped">
                                    <div class="form-group row">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="text-right">
                                            <a href="#ExportRs10" data-toggle="modal" class="btn btn-sm btn-primary"> <i class="fas fa-file-csv"></i> Rs10 Export</a>
                                        </div>
                                    </div>    
                            {{-- Export Rs10 --}}
                                    <div class="modal fade" id="ExportRs10" data-backdrop="static">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="get" action="{{ route('user.estamp.ExportEstamp') }}">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col">
                                                        ...
                                                        <input type="hidden" name="Rs10" value="Rs10">
                                                        ...
                                                        <tr id="tr_{{$stamp->id}}">
                                                            ...
                                                            <td>
                                                                @if (specificStampWiseBorrowerDetails($stamp->id) == null)
                                                                    <strong class="text-danger">Not Used</strong>
                                                                @else
                                                                    @php
                                                            ...
                                                            <td class="text-right">
                                                                <div class="single-line">
                                                                    ...
                                                                    <a href="javascript: void(0)" class="badge badge-dark action-button" title="Delete" onclick="confirm4lert('{{route('user.estamp.destroy')}}', {{$stamp->id}}, 'delete')">Delete</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                            ...
                            <div class="tab-pane fade pt-3" id="rs50" role="tabpanel" aria-labelledby="rs50-tab">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="text-right">
                                            <a href="#ExportRs50" data-toggle="modal" class="btn btn-sm btn-primary"> <i class="fas fa-file-csv"></i> Rs50 Export</a>
                                        </div>
                                    </div>    
                                    {{-- Export Rs50 --}}
                                    <div class="modal fade" id="ExportRs50" data-backdrop="static">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    Export Rs. 50
                                                ...
                                                <div class="modal-body">
                                                    <form method="get" action="{{ route('user.estamp.ExportEstamp') }}">
                                                        ...
                                                        <input type="hidden" name="Rs50" value="Rs50">
                                                        <div class="text-right mt-3">
                                                            <a href="{{ route('user.estamp.list') }}">
                                                                <span class="input-group-btn">
                                                                    <button class="btn btn-danger btn-sm rounded-0" type="button"
                            ...
                            <div class="tab-pane fade pt-3" id="rs100" role="tabpanel" aria-labelledby="rs100-tab">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="text-right">
                                            <a href="#ExportRs100" data-toggle="modal" class="btn btn-sm btn-primary"> <i class="fas fa-file-csv"></i> Rs100 Export</a>
                                        </div>
                                    </div>    
                                    {{-- Export Rs100 --}}
                                    <div class="modal fade" id="ExportRs100" data-backdrop="static">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    Export Rs. 100
                                                ...
                                                <div class="modal-body">
                                                    <form method="get" action="{{ route('user.estamp.ExportEstamp') }}">
                                                        ...
                                                        <input type="hidden" name="Rs100" value="Rs100">
                                                        <div class="text-right mt-3">
                                                            <a href="{{ route('user.estamp.list') }}">
                                                                <span class="input-group-btn">
                                                                    <button class="btn btn-danger btn-sm rounded-0" type="button"
                            ...
                            <div class="tab-pane fade pt-3" id="rs500" role="tabpanel" aria-labelledby="rs500-tab">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="text-right">
                                            <a href="#ExportRs500" data-toggle="modal" class="btn btn-sm btn-primary"> <i class="fas fa-file-csv"></i> Rs500 Export</a>
                                        </div>
                                    </div>    
                                    {{-- Export Rs500 --}}
                                    <div class="modal fade" id="ExportRs500" data-backdrop="static">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    Export Rs. 500
                                                ...
                                                <div class="modal-body">
                                                    <form method="get" action="{{ route('user.estamp.ExportEstamp') }}">
                                                        ...
                                                        <input type="hidden" name="Rs500" value="Rs500">
                                                        <div class="text-right mt-3">
                                                            <a href="{{ route('user.estamp.list') }}">
                                                                <span class="input-group-btn">
                                                                    <button class="btn btn-danger btn-sm rounded-0" type="button"
       ...
       $image_crop = $('#image_demo').croppie({
        ...
        $('.crop_image').click(function (event) {
            $image_crop.croppie('result', {
                ...
                $('.front_image_cropped').val(response);

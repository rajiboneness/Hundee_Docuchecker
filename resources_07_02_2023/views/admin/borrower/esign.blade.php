        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                                ...
                                <div class="">
                                    <div class="form-check">
                                        <label class="form-check-label" for="is_borrower">
                                            <input class="d-none" type="checkbox" name="is_borrower" checked value="1" id="is_borrower">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="">
                                    <div class="form-check">
                                        <label class="form-check-label" for="is_co_borrower">
                                            <input class="d-none" onclick="" type="checkbox" name="is_co_borrower" checked value="1" id="is_co_borrower"  {{$cb_checked}} {{$cb_disabled}}>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="">
                                    <div class="form-check">
                                        <label class="form-check-label" for="co_borrower_2" >
                                            <input class="d-none" onclick="" type="checkbox" name="co_borrower_2" checked value="1" id="co_borrower_2" {{$cb2_checked}} {{$cb2_disabled}}>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="">
                                    <div class="form-check">
                                        <label class="form-check-label" for="guarantor" >
                                            <input class="d-none" onclick="" type="checkbox" name="guarantor" checked value="1" id="guarantor">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="">
                                    <div class="form-check">
                                        <label class="form-check-label" for="executant">
                                            <input class="d-none" onclick="" type="checkbox" name="executant" checked value="1" id="executant">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="">
                                    <div class="form-check">
                                        <label class="form-check-label" for="is_authorised_signatory">
                                            <input class="d-none" onclick="" type="checkbox" value="1" checked name="is_authorised_signatory" id="is_authorised_signatory" {{$as_checked}} {{$as_disabled}} >
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="authorised_signatory_name" id="authorised_signatory_name" onchange="setValue(this)" id="authorised_signatory_name" class="form-control" {{ !empty($data->authorised_signatory_name) ? 'readonly' : '' }}>
                                                    ...
                                                    @foreach ($all_auth_sig as $item)
                                                        ...
                                                        <option value="{{$item->name}}" data-email="{{$item->email}}" data-city="{{$item->city}}" {{ (strtolower($data->authorised_signatory_name) == strtolower($item->name)) ? 'selected' : '' }}>{{$item->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="authorised_signatory_email" name="authorised_signatory_email" placeholder="select authorised signatory first" readonly>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="authorised_signatory_city" name="authorised_signatory_city" placeholder="select authorised signatory first" readonly>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="authorised_signatory_purpose" name="authorised_signatory_purpose" placeholder="Purpose" value="{{old('authorised_signatory_purpose') ? old('authorised_signatory_purpose') : 'e-signing by authorised signatory'}}" readonly>
                    ...
                    {{-- @php
                        $data = file_get_contents(asset('/esign/data.txt'));
                        print_r('Reqest id: '.json_decode($data)->request_id);echo "<br>";
                        print_r('issued_by: '.json_decode($data)->result->document->issued_by);echo "<br>";
                        print_r('signed_at: '.json_decode($data)->result->document->signed_at);echo "<br>";
                        print_r('signed_url: '.json_decode($data)->result->document->signed_url);echo "<br>";
                        print_r('given_name: '.json_decode($data)->result->signer->given_name);echo "<br>";
                        print_r('city: '.json_decode($data)->result->signer->city);echo "<br>";
                        print_r('postal_code: '.json_decode($data)->result->signer->postal_code);echo "<br>";
                        print_r('email: '.json_decode($data)->result->signer->email);

                        Illuminate\Support\Facades\DB::table('zoop_webhook_response')->where('request_id',json_decode($data)->request_id)->update(['signed_url'=>json_decode($data)->result->document->signed_url]);
                    @endphp --}}

                    <div class="card-body">
                        <div class="card shadow p-3">
                            <form enctype="multipart/form-data" action="{{route('user.esign.submitAgreement')}}" method="POST" class="row align-items-end">
                                @csrf
                                <input type="hidden" name="rfq_id" value="{{$rfqId}}">
                                <div class="form-group col-8 mb-0">
                                    <label for="">Upload Latest agreement copy after Signature</label>
                                    <input type="file" name="final_agreement" class="form-control form-control-sm">
                                </div>
                                <div class="col-4 d-flex">
                                    <button type="submit" class="btn btn-primary btn-sm"> Upload </button>
                                    <a href="{{asset($agreement_file)}}" target="_blank" class="mx-2 btn btn-primary btn-sm">Download agreement copy anytime</a>
                                </div>
                            </form>
                        </div>
                        <div class="borrowers-table-wrapper">
                            <table class="table table-sm table-bordered table-hover" id="borrowers-table">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:90%">
                                            <table style="width:100%;border:none;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:25%">Signatory Person</th>
                                                        <th style="width:25%">Mail Status</th>
                                                        <th style="width:25%">Signature Status</th>
                                ...
                                <tbody id="loadBorrowers">
                                    @forelse ($e_signatures as $item)
                                        @php
                                            $allresponse = Illuminate\Support\Facades\DB::table('zoop_webhook_response')->where('esign_uniq_id', $item)->get();
                                            $esignature_res = Illuminate\Support\Facades\DB::table('e_signatures')->where('unique_id', $item)->get();
                                        @endphp
                                        @if(count($allresponse) > 0)
                                        <tr>
                                            <td style="width:10%">{!!$app_id!!}</td>
                                            <td style="width:90%">
                                                <table style="width:100%;border:none;">
                                                    <tbody>
                                                        @foreach($esignature_res as $ekey => $eval)

                                                        @php
                                                            $comparisonName = $eval->user_name;

                                                            // Mr. Saptarshi's name is different in Aadhar card
                                                            if($eval->user_name == "Saptarshi Roy Bardhan") {
                                                                $comparisonName = "Saptarshi Roybardhan";
                                                            }

                                                            $signatureCheck = \DB::table('zoop_webhook_response')->where('esign_uniq_id', $item)->where('signer_name', $comparisonName)->first();
                                                        @endphp
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="badge badge-secondary">{{ date('F j, Y g:i A', strtotime($eval->created_at)) }}</div>
                                                            </td>
                                                            <td>
                                                                @if(!empty($signatureCheck))
                                                                    <div class="badge badge-success">Yes</div>
                                                                    <div class="badge badge-secondary">{{ date('F j, Y g:i A', strtotime($signatureCheck->signed_at)) }}</div>
                                                                @else
                                                            ...
                                                            <td>
                                                                @if(!empty($signatureCheck))
                                                                    <a target="_blank" href="{{json_decode(fetchAgreement($signatureCheck->request_id))->document->signed_url}}" class="badge badge-success">Signed Document</a>
                                                                @else
                                                                    <div class="badge badge-danger">Not Signed Yet</div>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                        ...
                                                        {{-- @foreach($allresponse as $key => $ar)
                                                            <tr>
                                                                <td style="width:25%">{{$ar->signer_name ?? $esignature_res[$key]->user_name}}</td>
                                                                <td style="width:25%">
                                                                    @if($ar->request_id != null) 
                                                                        <div class="badge badge-success">Yes</div>
                                                                        <div class="badge badge-secondary">{{ $esignature_res[$key]->created_at }}</div>
                                                                    @else
                                                                        <div class="badge badge-danger">No</div>
                                                                    @endif
                                                                </td>
                                                                <td style="width:25%">
                                                                    ...
                                                                    @else 
                                                                        <div class="badge badge-success">Yes</div>
                                                                        <div class="badge badge-secondary">{{ $ar->signed_at }}</div>
                                                                    @endif
                                                                </td>
                                                                <td style="width:25%">
                                                                    @if($ar->response == null) 
                                                                        <div class="badge badge-danger">Not Signed Yet</div> 
                                                                    @else
                                                                        <a target="_blank" href="{{json_decode(fetchAgreement($ar->request_id))->document->signed_url}}" class="badge badge-success">Signed Document</a> 
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                        @endforeach --}}
...
@section('script')
    ...
    {{-- <script>
        function fetchAgreementCopy(request_id) {
            $.ajax({
                url: 'https://live.zoop.one/contract/esign/v5/fetch/request',
                headers: {
                    'Access-Control-Allow-Origin' : 'http://hundee.torzo.in',

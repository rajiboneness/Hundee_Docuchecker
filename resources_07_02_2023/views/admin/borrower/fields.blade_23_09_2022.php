                                ...
                                <div class="col-md-6 text-right">
                                    @if ($data->agreementRfq > 0)
                                        <div class="mb-2">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-sm btn-{{CheckVernaculationData($id) ? 'success' : 'danger'}}" data-toggle="modal"
                                                data-target="#vernacularDeclarationModal">
                                                <i class="fas fa-{{CheckVernaculationData($id) ? 'check' : 'info'}}-circle mr-2"></i>
                                                Vernacular Declaration
                                            </a>

                                            <div class="modal fade" id="vernacularDeclarationModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form method="POST" action="{{route('user.borrower.storeVernacularDeclaration')}}" class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="vernacularDeclarationModalLabel">Set
                                                                VERNACULAR DECLARATION for Agreement</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row justify-content-between">
                                                                ...
                                                                <div class="col-lg-8 text-left">
                                                                    <div class="form-label">SET VERNACULAR DECLARATION
                                                                        LANGUAGE</div>
                                                                </div>
                                                            ...
                                                            <div
                                                                class="row mt-3 w-100 align-items-center justify-content-between">
                                                                <div class="col-6 text-left">
                                                                    <h5>Borrower : </h5>
                                                                </div>
                                                                <div class="col-6 text-right">
                                                                    <label class="form-label">
                                                                        <input type="checkbox" name="borrower_check" value="Yes" {{CheckVernaculationData($id) && VernaculationData($id)['borrower_check'] == 'Yes' ? 'checked' : ''}}>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            @if (coborrowerAndgurantor($data->rfqDetails->id)['name_cb1'] != '')
                                                                <div
                                                                    ...
                                                                    <div class="col-6 text-right">
                                                                        <label class="form-label">
                                                                            <input type="checkbox" name="coborrower_check" value="Yes" {{CheckVernaculationData($id) && VernaculationData($id)['coborrower_check'] == 'Yes' ? 'checked' : ''}}>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if (coborrowerAndgurantor($data->rfqDetails->id)['name_cb2'] != '')
                                                                <div
                                                                    ...
                                                                    <div class="col-6 text-right">
                                                                        <label class="form-label">
                                                                            <input type="checkbox" name="co2borrower_check" value="Yes" {{CheckVernaculationData($id) && VernaculationData($id)['co2borrower_check'] == 'Yes' ? 'checked' : ''}}>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if (coborrowerAndgurantor($data->rfqDetails->id)['name_gur'] != '')
                                                                <div
                                                                    ...
                                                                    <div class="col-6 text-right">
                                                                        <label class="form-label">
                                                                            <input type="checkbox" name="gurrantor_check" value="Yes" {{CheckVernaculationData($id) && VernaculationData($id)['gurrantor_check'] == 'Yes' ? 'checked' : ''}}>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            @endif
                                            ...
                                            @if ($data->annX5dataCount > 0 && $data->annX5dataCount > 0)
                                                <a href="javascript:void(0)"
                                                    ...
                                                    id="eSignatureSendBtn" class="btn btn-sm btn-secondary">

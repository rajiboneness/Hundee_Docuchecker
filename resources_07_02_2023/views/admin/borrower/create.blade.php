                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @csrf
                                ...
                                {{-- <div class="form-group row">
                                    <label for="app_id" class="col-sm-2 col-form-label">App ID<span class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('app_id') {{ 'is-invalid' }} @enderror" id="app_id" name="app_id" placeholder="App ID" value="{{ old('app_id') }}">
                                        @error('app_id') <p class="small mb-0 text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                </div> --}}
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 offset-sm-2 mt-2">
                                        <select type="text" class="form-control @error('KYC_POST_OFFICE') {{ 'is-invalid' }} @enderror" id="KYC_POST_OFFICE" name="KYC_POST_OFFICE" value="{{ old('KYC_POST_OFFICE') }}">
                                    ...
                                    <div class="col-sm-10 offset-sm-2 mt-2">
                                        <input type="text" class="form-control @error('KYC_District') {{ 'is-invalid' }} @enderror" id="KYC_District" name="KYC_District" placeholder="District" value="{{ old('KYC_District') }}">
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-2 col-sm-10 text-right">
                                        <button type="submit" class="btn btn-primary">Send details for DocuChecker</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        if(result[0].Message != 'No records found'){
                            if(result[0].PostOffice.length > 0){
                                ...
                                result[0].PostOffice.forEach(element => {
                                    if(element.Name == "{{old('KYC_POST_OFFICE')}}")

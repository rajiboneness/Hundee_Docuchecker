                                    ...
                                    <form action="{{ route('user.borrower.list') }}" method="GET" role="search">
                                        <div class="input-group">
                                            <select name="show" onchange="$(this).parent().parent().submit()" class="form-control  form-control-sm mx-1">
                                                <option {{request()->input('show') == 'borrowers' ? 'selected' : ''}} value="borrowers">Borrowers only</option>
                                                <option {{request()->input('show') == 'borrower & agreement' ? 'selected' : ''}} value="borrower & agreement">Borrower-Agreements</option>
                                            </select>

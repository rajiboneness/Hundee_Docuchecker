                                                        ...
                                                        <td>
                                                            ...
                                                            <img src="{{asset($item->image_path)}}" alt="user-image-{{ $item->id }}">
                                                                ...
                                                                <div class="flex-grow-1 ms-3">
                                                                    ...
                                                                    <p class="small text-muted mb-0">{{ $item->RM_ID ? 'RM: '.$item->Users->name : '' }}</p>

                                                                    @if (request()->input('show') == 'borrower & agreement')
                                                                        <a href="#assignRM{{ $index+1 }}" class="badge badge-dark action-button" data-toggle="modal" title="assign">{{ $item->RM_ID ? "Update RM" : "Assign RM" }}</a>
                                                                                    ...
                                                                                    <form method="post">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <select name="rm_name" class="form-control" id="rm_name{{ $index+1 }}">
                                                                                                    <option value="">Select Relationship Manager</option>
                                                                                                    @foreach($userData as $RMKey => $RM)
                                                                                                    <option value="{{ $RM->id }}" {{ $RM->id==$item->RM_ID ? 'Selected': '' }}>{{ $RM->name }}</option>
                                                                                                    @endforeach
                                                                                                </select>
            ...
            $.ajax({type: "POST",
                ...
                success:function(result){
                    if(result.status ==200){
                        $('#alertSms'+id+'').addClass('badge badge-success').html("Successfully Assign RM");
                        setTimeout(function () {

                        ...
                        <div class="tab-pane fade show active" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="card" style="box-shadow: 0 0 1px rgb(0 0 0 / 0%), 0 1px 3px rgb(0 0 0 / 0%);">
                                ...
                                <div class="card-body p-1 py-3">
                                    ...
                                    <div class="card-title font-weight-bold mb-3 text-muted">Available 100Rs Estamps - <span class="text-dark">{{ availableStampNew(100)->count() }}</span> </div>
                        ...
                        <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="card" style="box-shadow: 0 0 1px rgb(0 0 0 / 0%), 0 1px 3px rgb(0 0 0 / 0%);">
                                ...
                                <div class="card-body p-1 py-3">
                                    ...
                                    <div class="card-title font-weight-bold mb-3 text-muted">Available 10Rs Estamps - <span class="text-dark">{{ availableStampNew(10)->count() }}</span> </div>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="card" style="box-shadow: 0 0 1px rgb(0 0 0 / 0%), 0 1px 3px rgb(0 0 0 / 0%);">
                                ...
                                <div class="card-body p-1 py-3">
                                    ...
                                    <div class="card-title font-weight-bold mb-3 text-muted">Available 50Rs Estamps - <span class="text-dark">{{ availableStampNew(50)->count() }}</span> </div>

...
@section('title', 'Manage Functional Specification Document(FSD)')
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                {{-- <a href="{{ route('user.fsd.list') }}" class="btn btn-sm btn-primary"> <i class="fas fa-chevron-left"></i> Back to users</a> --}}
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr id="tr_{{ $item->id }}">
                                            ...
                                            <td class="text-right">
                                                <a href="javascript: void(0)" class="badge badge-dark action-button"
                                                    title="View"
                                                    onclick="viewDeta1ls('{{ route('user.fsd.show') }}', {{ $item->id }}, 'view')">View</a>

                                                <a href="javascript: void(0)" class="badge badge-dark action-button"
                                                    title="Edit"
                                                    onclick="viewDeta1ls('{{ route('user.fsd.show') }}', {{ $item->id }}, 'edit')">Edit</a>

                                                <a href="javascript: void(0)" class="badge badge-dark action-button"
                                                    title="Delete"
                                                    onclick="confirm4lert('{{ route('user.fsd.destroy') }}', {{ $item->id }}, 'delete')">Delete</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
...
@section('script')
    <script>
        ...
        function openSidebarModal() {
            ...
            content +=
                '<p class="text-dark small mb-1">Document Name <span class="text-danger">*</span></p><input type="text" class="form-control form-control-sm mb-2" name="doc_name" id="nameCreate" placeholder="FSD Document name">';
            content +=
                '<p class="text-dark small mb-1">Document File <span class="text-danger">*</span></p><input type="text" class="form-control form-control-sm mb-2" name="doc_file" id="nameCreate" placeholder="FSD Document file path">';
        ...
        function storeDept() {
            ...
            $.ajax({
                url: '{{ route('user.fsd.store') }}',
                method: 'post',
                data: {
                    '_token': '{{ csrf_token() }}',
                    'doc_name': $('input[name="doc_name"]').val(),
                    'doc_file': $('input[name="doc_file"]').val(),
                },

                ...
                success: function(result) {
                    ...
                    if (result.error == false) {
                        if (type == 'view') {
                            ...
                            $('#userDetails .modal-content').append(
                                '<div class="modal-footer text-right"><a href="javascript: void(0)" class="btn btn-sm btn-success" onclick="updateOffice1()">Update changes <i class="fas fa-upload"></i> </a></div>'
                            );

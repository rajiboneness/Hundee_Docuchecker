    ...
    <div id="outer_content">
		...
		<table class="sign-table" cellpadding="0" cellspacing="0" style="border: 0">
            ...
            <div class="page" id="page_17">
                ...
                <tr>
                    ...
                    <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                        ...
                        <p class="ft1" style="text-align:left; margin-top: 15px;">
            ...
            <div class="page" id="page_37">
                ...
                <table cellpadding=0 cellspacing=0 class="sign-table" style="position: relative;margin-top: 80px">
                    <tr>
                        <td>
                            {{-- <p style="margin-bottom: 0">{{$data->nameoftheborrower}}</p> --}}
                            <p>{{$data->nameoftheborrower}}</p>
            ...
            <div class="page" id="page_38">
                ...
                <table cellpadding=0 cellspacing=0 class="sign-table" style="position: relative;margin-top:50px">
                    <tr>
                        <td>
                            {{-- <p style="margin-bottom: 0">{{$data->nameoftheborrower}}</p> --}}
                            <p>{{$data->nameoftheborrower}}</p>
                        ...
                        <div class="page" id="page_40">
                            ...
                            <table class="border0" style="width:100%;">
                                <tr>
                                    <td class="border0">
                                        <p>
                                            আমি শ্রী / শ্রীমতী, {{VernaculationData($data->borrowerAgreementsId)['executant_name']}} {{VernaculationData($data->borrowerAgreementsId)['is_executant_fathers_or_husband'] == 'Husband' ? 'স্বামীর' : 'পিতা'}} নাম {{VernaculationData($data->borrowerAgreementsId)['executant_fathers_or_husband_name']}} নিবাস
                                            {{VernaculationData($data->borrowerAgreementsId)['executant_adress']}} নির্বাহক হিসেবে নিশ্চিতরূপে ,দায়বধ্যতার সঙ্গে  জানাচ্ছি যে :
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <table cellpadding=0 cellspacing=0 class="sign-table" style="position: relative;">
                                <tr>
                                    ...
                                    <td>
                                        <p style="margin-bottom: 0">{{VernaculationData($data->borrowerAgreementsId)['executant_name']}}</p>
                                        <div class="sign-line"></div>
                            ...
                            <div class="page" id="page_40">
                                ...
                                <table class="border0" style="width:100%;">
                                    <tr>
                                        <td class="border0">
                                            <p>
                                                मैं, {{VernaculationData($data->borrowerAgreementsId)['executant_name']}} {{VernaculationData($data->borrowerAgreementsId)['is_executant_fathers_or_husband'] == 'Husband' ? 'पत्नी' : 'पुत्र'}} {{VernaculationData($data->borrowerAgreementsId)['executant_fathers_or_husband_name']}} रहने
                                                {{VernaculationData($data->borrowerAgreementsId)['executant_adress']}} एतद्द्वारा निम्नलिखित कथन करते हैं और गंभीर प्रतिज्ञान पर घोषणा करते हैं:
                                            </p>
                                        </td>
                                    </tr>

        ...
        <div id="DivIdToPrint">
            ...
            <div class="page" id="page_35">
                <div style="text-align:center;">
                    ...
                    <br><br><br>
                    <img src="{{asset($data->annexurefiveimagepageone)}}" class="p-3" style="width: 93%; height: 60%;">
                </div>
            ...
            <div class="page" id="page_36">
                <div style="text-align:center;">
                    ...
                    <br><br><br>
                    <img src="{{asset($data->annexurefiveimagepagetwo)}}" class="p-3" style="width: 93%; height: 60%;">
                </div>

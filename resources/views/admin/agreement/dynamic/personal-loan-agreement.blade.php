...
<body>
    <header class="pdf-header">
        <div style="width:100%; max-width: 1000px; margin: 0 auto; display: flex; align-items: center; justify-content: space-between;">
            ...
            @else
                <button class="modal-toggle btn btn-sm btn-primary">
                    Print
    ...
    <div id="outer_content">
            ...
            <div class="page">
                <table style="margin-top: 200px; text-align: left;" class="table_1">
                    ...
                    <tr>
                        ...
                        <td>
                            {{$data->borrower_agreement_data->application_id}}
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="page" id="page_2">
                ...
                <table cellpadding=0 cellspacing=0 class="indexTable">
                    ...
                    <tr>
                        ...
                        <td>{{$data->nameoftheguarantor ? '34' : '33'}}</td>
                    </tr>
                    @endif
                    {{-- <tr>
                        <td>5</td>
                            ...
                            <ol style="padding-left: 0;" type="a">
                                ...
                                <li>
                                    ...
                                    <p>
                                        ...
                                        cash deposit in the Lender's bank account, on any exigency, within the limits permissible under the Income Tax Act, 1961 and the Rules made thereunder and such other laws, as may be applicable.
                                    </p>
                                </li>
                            </ol>
                        </td>
		...
		<table class="sign-table" cellpadding="0" cellspacing="0" style="border: 0">
            ...
            <div class="page" id="page_17">
                ...
                <table class="border0" style="table-layout: fixed; height: 351px;">
                    <tr>
                            ...
                            <table class="border0 witnessTable">
                                ...
                                <tr>
                                    ...
                                    <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                                        ...
                                        <p class="cps" style="margin-top: 5px;">
                                            <span style="display: contents;">State : {{$data->witness1state}}</span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="border0 witnessTable">
                                ...
                                <tr>
                                    ...
                                    <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                                        ...
                                        <p class="cps" style="margin-top: 5px;">
                                            <span style="display: contents;">State : {{$data->witness2state}}</span>
                                        </p>
                            ...
                            <table class="border0 witnessTable">
                                ...
                                <tr>
                                    ...
                                    <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                                        ...
                                        <p class="cps" style="margin-top: 5px;">
                                            <span style="display: contents;">State : {{$data->stateoftheguarantor}}</span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
            ...
            <div class="page" id="page_18">
                ...
                <table class="table_17">
                    <tr>
                        ...
                        <td>
                            {{$data->nameofthecoborrower ? $data->nameofthecoborrower : 'N/A'}}
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table class="table_17" style="display:none">
                    <tr>
                        <td>
                ...
                <table class="table_17" style="display:{{$data->nameoftheguarantor ? 'none' : 'table'}}">
                    <tr>
                        <td>
            ...
            {{-- If Gurrantor available then --}}
            @if($data->nameoftheguarantor)
            ...
            <div class="page" id="page_28">
                ...
                <table class="table_23 border0" style="width:100%; margin:0 auto;">
                    ...
                    <tr class="stamp-tr">
                        <td class="border0">
                            <p style="margin-top: 85px; margin-bottom: 0;">{{$data->nameoftheborrower}}</p>
                        </td>
                        <td class="border0">
                            <p style="margin-top: 85px; margin-bottom: 0;">{{$data->nameofthecoborrower}}</p>
                            <p style="margin: 0;">{{$data->nameofthecoborrower2}}</p>
                        </td>
                        <!-- <td class="border0">
                                    ...
                                    <td class="border0">
                                        <p>
                                            <span>
                                                শ্রী / শ্রীমতী
                                                {{$data->nameoftheborrower}}
                                                {{VernaculationData($data->borrowerAgreementsId)['is_borrower_father_or_husband'] == 'Husband' ? 'স্বামীর' : 'পিতার'}} নাম {{strtoupper(VernaculationData($data->borrowerAgreementsId)['borrower_father_or_husband_name'])}}
                                    ...
                                    <td class="border0">
                                        <p>
                                            <span>
                                                শ্রী / শ্রীমতী
                                                {{$data->nameofthecoborrower}}
                                                {{VernaculationData($data->borrowerAgreementsId)['is_coborrower_father_or_husband'] == 'Husband' ? 'স্বামীর' : 'পিতার'}} নাম {{strtoupper(VernaculationData($data->borrowerAgreementsId)['coborrower_father_or_husband_name'])}}
                                    ...
                                    <td class="border0">
                                        <p>
                                            <span>
                                                ...
                                                {{VernaculationData($data->borrowerAgreementsId)['is_co2borrower_father_or_husband'] == 'Husband' ? 'স্বামীর' : 'পিতার'}} নাম {{strtoupper(VernaculationData($data->borrowerAgreementsId)['co2borrower_father_or_husband_name'])}}
                                    ...
                                    <td class="border0">
                                        <p>
                                            <span>
                                                শ্রী / শ্রীমতী
                                                {{$data->nameoftheguarantor}}
                                                {{VernaculationData($data->borrowerAgreementsId)['is_gurrantor_father_or_husband'] == 'Husband' ? 'স্বামীর' : 'পিতার'}} নাম {{strtoupper(VernaculationData($data->borrowerAgreementsId)['gurrantor_father_or_husband_name'])}}
                                ...
                                <table class="border0" style="width:100%;">
                                    ...
                                    <tr>
                                        <td class="border0">
                                            <p>
                                                <span>
                                                    कि उधारकर्ता श्री/श्रीमती/सुश्री {{$data->nameoftheborrower}} 
                                                    {{VernaculationData($data->borrowerAgreementsId)['is_borrower_father_or_husband'] == 'Husband' ? 'पति' : 'पिता'}} का नाम {{strtoupper(VernaculationData($data->borrowerAgreementsId)['borrower_father_or_husband_name'])}}
                                                    {{-- पुत्र/ पुत्री / पत्नी ……………………………………… मेरा ……………………… है --}} ,और मैं उसे जानता/जानती हूँ पिछले {{VernaculationData($data->borrowerAgreementsId)['executant_know_borrower_years']}} वर्षों / महीनों से और वह स्थानीय भाषा हिन्दी में हस्ताक्षर करता है, और उसे उसके द्वारा समझ लिया गया है। मैंने उसे सामान्य कारोबार/लेनदेन के दौरान हस्ताक्षर करते देखा है।
                                                </span>
                                            </p>
                                        </td>
                                    </tr>
                                ...
                                <table class="border0" style="width:100%;">
                                    ...
                                    <tr>
                                        <td class="border0">
                                            <p>
                                                <span>
                                                    कि उधारकर्ता श्री/श्रीमती/सुश्री {{$data->nameofthecoborrower}}
                                                    {{--पुत्र/ पुत्री / पत्नी ……………………………………… मेरा ……………………… है और--}} 
                                                    {{VernaculationData($data->borrowerAgreementsId)['is_coborrower_father_or_husband'] == 'Husband' ? 'पति' : 'पिता'}} का नाम {{strtoupper(VernaculationData($data->borrowerAgreementsId)['coborrower_father_or_husband_name'])}}
                                                    मैं उसे जानता/जानती हूँ पिछले {{VernaculationData($data->borrowerAgreementsId)['executant_know_coborrower_years']}} वर्षों / महीनों से और वह स्थानीय भाषा हिन्दी में हस्ताक्षर करता है, और उसे उसके द्वारा समझ लिया गया है। मैंने उसे सामान्य कारोबार/लेनदेन के दौरान हस्ताक्षर करते देखा है।
                                                </span>
                                            </p>
                                        </td>
                                    </tr>
                                ...
                                <table class="border0" style="width:100%;">
                                    ...
                                    <tr>
                                        <td class="border0">
                                            <p>
                                                <span>
                                                    कि उधारकर्ता श्री/श्रीमती/सुश्री {{$data->nameofthecoborrower2}} 
                                                    {{-- पुत्र/ पुत्री / पत्नी ……………………………………… मेरा ……………………… है और  --}}
                                                    {{VernaculationData($data->borrowerAgreementsId)['is_co2borrower_father_or_husband'] == 'Husband' ? 'पति' : 'पिता'}} का नाम {{strtoupper(VernaculationData($data->borrowerAgreementsId)['co2borrower_father_or_husband_name'])}}
                                                    मैं उसे जानता/जानती हूँ पिछले {{VernaculationData($data->borrowerAgreementsId)['executant_know_coborrower_years']}} वर्षों / महीनों से और वह स्थानीय भाषा हिन्दी में हस्ताक्षर करता है, और उसे उसके द्वारा समझ लिया गया है। मैंने उसे सामान्य कारोबार/लेनदेन के दौरान हस्ताक्षर करते देखा है।
                                                </span>
                                            </p>
                                        </td>
                                ...
                                <table class="border0" style="width:100%;">
                                    ...
                                    <tr>
                                        <td class="border0">
                                            <p>
                                                <span>
                                                    कि उधारकर्ता श्री/श्रीमती/सुश्री {{$data->nameoftheguarantor}} 
                                                    {{-- पुत्र/ पुत्री / पत्नी ……………………………………… मेरा ……………………… है और  --}}
                                                    {{VernaculationData($data->borrowerAgreementsId)['is_gurrantor_father_or_husband'] == 'Husband' ? 'पति' : 'पिता'}} का नाम {{strtoupper(VernaculationData($data->borrowerAgreementsId)['gurrantor_father_or_husband_name'])}}
                                                    मैं उसे जानता/जानती हूँ पिछले {{VernaculationData($data->borrowerAgreementsId)['executant_know_coborrower_years']}} वर्षों / महीनों से और वह स्थानीय भाषा हिन्दी में हस्ताक्षर करता है, और उसे उसके द्वारा समझ लिया गया है। मैंने उसे सामान्य कारोबार/लेनदेन के दौरान हस्ताक्षर करते देखा है।
                                                </span>
                                            </p>
                                        </td>
    ...
    <div class="modal">
        ...
        <div class="modal-wrapper modal-transition">          
            <div class="modalClose">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g transform="matrix(0.7500000000000001,0,0,0.7500000000000001,63.99999967939203,63.999593653483345)"><g id="_02_User" data-name="02 User"><path d="m25 512a25 25 0 0 1 -17.68-42.68l462-462a25 25 0 0 1 35.36 35.36l-462 462a24.93 24.93 0 0 1 -17.68 7.32z" fill="#717171" data-original="#000000" class=""></path><path d="m487 512a24.93 24.93 0 0 1 -17.68-7.32l-462-462a25 25 0 0 1 35.36-35.36l462 462a25 25 0 0 1 -17.68 42.68z" fill="#717171" data-original="#000000" class=""></path></g></g></svg>
            </div>
          <div class="modal-body">
            <div class="modal-content">
                <div class="icon-box">
                    <div class="portrait">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 64 64" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="m51 58h-38v-52h38zm-36-2h34v-48h-34zm32-2h-30v-44h30zm-28-2h26v-40h-26z" fill="#000000" data-original="#000000" class=""></path></g></svg>
                        <div class="right">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 90 90" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><g><path d="m75.802 19.31c-.844.025-1.646.375-2.234.984l-42.532 42.426-14.603-14.635c-.609-.631-1.448-.991-2.328-.991-2.922-.009-4.37 3.543-2.271 5.579l16.85 16.891c.063.068.13.131.197.188 1.5 1.411 3.922 1.083 4.995-.672l44.281-44.183c2.14-2.062.614-5.677-2.355-5.587z" fill="#0dc71a" data-original="#000000" class=""></path></g></g></svg>
                        </div>
                    </div>
                    <div class="landscape">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 64 64" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g transform="matrix(6.123233995736766e-17,1,-1,6.123233995736766e-17,64,0)"><path d="m51 58h-38v-52h38zm-36-2h34v-48h-34zm32-2h-30v-44h30zm-28-2h26v-40h-26z" fill="#000000" data-original="#000000" class=""></path></g></svg>
                        <div class="wrong">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g transform="matrix(0.7500000000000001,0,0,0.7500000000000001,63.99999967939203,63.999593653483345)"><g id="_02_User" data-name="02 User"><path d="m25 512a25 25 0 0 1 -17.68-42.68l462-462a25 25 0 0 1 35.36 35.36l-462 462a24.93 24.93 0 0 1 -17.68 7.32z" fill="#ff0000" data-original="#000000" class=""></path><path d="m487 512a24.93 24.93 0 0 1 -17.68-7.32l-462-462a25 25 0 0 1 35.36-35.36l462 462a25 25 0 0 1 -17.68 42.68z" fill="#ff0000" data-original="#000000" class=""></path></g></g></svg>
                        </div>
                    </div>
                </div>
                <p class="alert-text text-center">
                    Download to be mandatory in <br> <strong>portrait</strong> layout and page <strong>type A4</strong>  
                </p>
                @if (request()->input('type') == "esign")
                <button id='print-btn' onclick='htmlToPdfAjax();' class="btn btn-sm btn-primary">Proceed with this document <i class="fas fa-chevron-right"></i> </button>
                @else
                    <button id='print-btn' onclick='printDiv();' class="btn btn-sm btn-primary">
                        Ok
                    </button>
                @endif
            </div>

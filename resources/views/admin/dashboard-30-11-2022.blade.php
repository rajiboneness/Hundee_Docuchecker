                            ...
                            <div class="table-responsive">
                                <table class="table table-sm m-0">
                                    ...
                                    <tbody>
                                        ...
                                        @if (count(getEsignDetails($rfq_id)) > 0)    
                                            <tr>
                                                <td rowspan="{{getEsignDetails($rfq_id)}}">
                                                    <p class="small text-muted">{{$signers->application_id}}</p>
                                                </td>
                                                @foreach (getEsignDetails($rfq_id) as $key => $item)
                                                    <td>
                                                        {{$item->user_name}}
                                                    ...
                                                    <td>
                                                        @if(getWebHookResponses($item->unique_id)[$key]->signed_at != null)
                                                            <div class="badge badge-sm badge-success">Yes</div>
                                                    ...
                                                    <td>
                                                        @if(getWebHookResponses($item->unique_id)[$key]->signed_at != null)
                                                            <a href="{{getWebHookResponses($item->unique_id)[$key]->signed_url}}" class="badge badge-sm badge-success">Signed Document</a>
                                                        @else

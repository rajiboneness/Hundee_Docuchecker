                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-sm-left">
                                    <div class="mb-2">
                                        ...
                                        @endphp
                                        @endif --}}
                                        <a href="{{ route('user.borrower.setAnnexure5doc', [$id]) }}" class="mb-1 btn {{auth()->user()->user_type == 1 || auth()->user()->user_type == 3 ? '' : 'disabled'}} btn-sm btn-{{ $data->annX5dataCount == 0 ? 'danger' : 'success' }}" rel="1" onclick="GetDetails(this.id,this.rel)">
                                        ...
                                        <a href="javascript:void(0)" class="mb-1 btn {{auth()->user()->user_type == 1 || auth()->user()->user_type == 3 ? '' : 'disabled'}} btn-sm btn-{{CheckVernaculationDataSet($id) ? 'success' : 'danger'}}" data-toggle="modal"
                                            data-target="#vernacularDeclarationModal" rel="2" onclick="GetDetails(this.id,this.rel)">
                                        ...
                                        @if ($data->stampPaper1 && $data->stampPaper2 && $data->stampPaper3 && $data->stampPaper4)
                                            ...
                                            <a href="#viewPdfModal" data-toggle="modal" class="btn btn-sm btn-success {{auth()->user()->user_type == 1 || auth()->user()->user_type == 3 ? '' : 'disabled'}}" rel="3" id="#viewPdfModal" onclick="GetDetails(this.id,this.rel)">
                                                <i class="fas fa-check-circle mr-2"></i> Stamp Paper
                                            </a>
                                        @else
                                            <a href="#viewPdfModal" data-toggle="modal" class="btn btn-sm btn-danger {{auth()->user()->user_type == 1 || auth()->user()->user_type == 3 ? '' : 'disabled'}}" rel="4" id="#viewPdfModal" onclick="GetDetails(this.id,this.rel)">
                                                                ...
                                                                <tr>
                                                                    <td colspan="3"
                                                                        ...
                                                                        <div class="w-100 text-right">
                                                                            ...
                                                                            @else
                                                                                <button type="button"
                                                                                    class="btn btn-sm btn-primary form_submit_btn">Submit data1
                                                                                    <i class="fas fa-upload"></i></button>
                                                                            @endif
                                                                        </div>
                                                                    </td>

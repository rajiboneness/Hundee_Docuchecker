...
@section('script')
    ...
    <script>
        ...
        $('input[name="field_name[pancardnumberofthecoborrower]"]').on('keyup',function(){
            // if($('input[name="field_name[pancardnumberofthecoborrower]"]').val() == 10){
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        $('select[name="field_name[prefixofthecoborrower]"]').val(details[0].field_value).change();
                        $('input[name="field_name[nameofthecoborrower]"]').val(details[1].field_value);
                        // $('input[name="field_name[pancardnumberofthecoborrower]"]').val(details[3].field_value);
                        if($('input[name="field_name[officiallyvaliddocumentsofthecoborrower]"]').val() == details[4].field_value)
                            // console.log("Hiii");    
                            $('input[name="field_name[officiallyvaliddocumentsofthecoborrower]"]').attr('checked',true);
                        
                        $('input[name="field_name[occupationofthecoborrower]"]').val(details[17].field_value);
                        $('select[name="field_name[maritalstatusofthecoborrower]"]').val(details[20].field_value).change();
                        $('select[name="field_name[highesteducationofthecoborrower]"]').val(details[21].field_value).change();
                        $('input[name="field_name[mobilenumberofthecoborrower]"]').val(details[22].field_value);
                        $('input[name="field_name[emailidofthecoborrower]"]').val(details[23].field_value);
                        // $('input[name="field_name[nameofthecoborrower]"]').val(details[1].field_value);
                        // console.log(details[0].field_value);
                    }
                })
            // }else{
            //     $('select[name="field_name[prefixofthecoborrower]"]').val('').change();
            //     $('input[name="field_name[nameofthecoborrower]"]').val('');
            //     // $('input[name="field_name[pancardnumberofthecoborrower]"]').val('');
            //     if($('input[name="field_name[officiallyvaliddocumentsofthecoborrower]"]').val() == '')
            //         $('input[name="field_name[officiallyvaliddocumentsofthecoborrower]"]').attr('checked=checked');
                        
            //     $('input[name="field_name[occupationofthecoborrower]"]').val('');
            //     $('select[name="field_name[maritalstatusofthecoborrower]"]').val('').change();
            //     $('select[name="field_name[highesteducationofthecoborrower]"]').val('').change();

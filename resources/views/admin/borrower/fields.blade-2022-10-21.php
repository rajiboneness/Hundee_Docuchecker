                                ...
                                <div class="col-md-6 text-sm-left">
                                    <div class="mb-2">
                                        <a href="{{ route('user.borrower.setAnnexure5doc', [$id]) }}"
                                            class="btn btn-sm btn-{{ $data->annX5dataCount == 0 ? 'danger' : 'success' }}">
                                            {!! $data->annX5dataCount == 0
                                                ? '<i class="fas fa-info-circle mr-2"></i>'
                                                : '<i class="fas fa-check-circle mr-2"></i>' !!}
                                            ANEXTURE-V Content
                                        </a>
                                        <a href="javascript:void(0)" class="btn btn-sm btn-{{CheckVernaculationDataSet($id) ? 'success' : 'danger'}}" data-toggle="modal"
                                                       ...
                                                       <div id="vdata">
                                                                ...
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="form-group col-6 text-left">
                                                                        ...
                                                                        <select class="form-control" name="is_executant_fathers_or_husband">
                                                                            <option {{VernaculationData($id)['is_executant_fathers_or_husband'] == 'Father' ? 'checked' : ''}} value="Father">Father</option>
                                                                            <option {{VernaculationData($id)['is_executant_fathers_or_husband'] == 'Husband' ? 'checked' : ''}} value="Husband">Husband</option>
                                                                        </select>
                                                            ...
                                                            @if (coborrowerAndgurantor($data->rfqDetails->id)['name_cb1'] != '')
                                                                <div>
                                                                    ...
                                                                    <input type="number" value="{{VernaculationData($id)['executant_know_coborrower_years']}}" class="form-control {{CheckVernaculationData($id) && VernaculationData($id)['coborrower_check'] == 'Yes' ? '' : 'd-none'}}" placeholder="Years Executant know borrower" name="executant_know_coborrower_years" id="executant_know_coborrower_years">
                                                                </div>
                                                            @endif
                                                            @if (coborrowerAndgurantor($data->rfqDetails->id)['name_cb2'] != '')
                                                                <div>
                                                                    ...
                                                                    <input type="number" value="{{VernaculationData($id)['executant_know_coborrower2_years']}}" class="form-control {{CheckVernaculationData($id) && VernaculationData($id)['co2borrower_check'] == 'Yes' ? '' : 'd-none'}}" placeholder="Years Executant know borrower" name="executant_know_coborrower2_years" id="executant_know_coborrower2_years">
                                                                </div>
                                                            @endif
                                                            @if (coborrowerAndgurantor($data->rfqDetails->id)['name_gur'] != '')
                                                                <div>
                                                                    ...
                                                                    <input type="number" value="{{VernaculationData($id)['executant_know_gurrantor_years']}}" class="form-control {{CheckVernaculationData($id) && VernaculationData($id)['gurrantor_check'] == 'Yes' ? '' : 'd-none'}}" placeholder="Years Executant know borrower" name="executant_know_gurrantor_years" id="executant_know_gurrantor_years">
                                                                </div>
                                                            @endif
                                                        </div>
                                                   </div>
                                                            ...
                                                            <tr>         
                                                                ...
                                                                @if($data->borrower_agreement[0]->application_id == null)
                                                                    <td class="fields_col-2">
                                                                        <div class="w-100 d-flex"><input type="number" placeholder="App ID" class="form-control form-control-sm " name="application_id"></div>

                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="#csvUploadModal" data-toggle="modal" class="btn btn-sm btn-primary"> <i
                                        class="fas fa-file-csv"></i> Upload CSV</a>
                                <a href="{{ route('user.borrower.create') }}" class="btn btn-sm btn-primary"> <i
                                        class="fas fa-plus"></i> Create new borrower</a>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td>
                                                <div class="single-line">
                                                    @if (count($item->agreement) > 0)
                                                        @foreach ($item->agreement as $agreement)
                                                            <a href="{{ route('user.borrower.agreement', $agreement->id) }}"
                                                                ...
                                                                title="Setup loan application form">View Agreement</a>
                                                            @if ($item->borrowerAgreementRfq)
                                                                <br>
                                                                <a href="{{ route('user.borrower.setRm', [$agreement->id]) }}"
                                                    ...
                                                    @else
                                                        ...
                                                        <br>
                                                        <a href="{{ route('user.borrower.agreement.setup', $item->id) }}"
                                                            class="badge badge-dark action-button">Add new</a>
                                                    @endif
                                                </div>
                                            </td>
                                            <td class="text-right">
                                                <div class="single-line">
                                                    ...
                                                    <a href="javascript: void(0)" class="badge badge-dark action-button"
                                                        title="Delete"
                                                        onclick="confirm4lert('{{ route('user.borrower.destroy') }}', {{ $item->id }}, 'delete')">Delete</a>
                                                    {{-- @if ($item->borrowerAgreementRfq)
                                                        <br>
